...
## Hardwear
The full hardwear setup is described in the documentation, but for the instalation you'll only need a networked connected Raspberry Pi Zero 2 initialized with a decetly recent version of [Raspberry Pi OS Lite (64-bit)](https://downloads.raspberrypi.com/raspios_lite_arm64/images/raspios_lite_arm64-2026-04-21/2026-04-21-raspios-trixie-arm64-lite.img.xz).
